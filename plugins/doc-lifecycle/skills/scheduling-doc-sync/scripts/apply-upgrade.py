...
doc-judgment left in it: re-copy the eight vendored scripts, re-render the three
...
Ownership (total on wiring, idempotent on state):
    ...
    .github/doc-sync/*.py (eight scripts)                        overwrite
...
# Vendored scripts and the skill dir each is copied from (five from this skill,
...
SCRIPTS = {
    ...
    "authorize-paths.py": "scheduling-doc-sync/scripts",
